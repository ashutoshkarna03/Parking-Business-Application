...
export class ParkingSpaceService {
  ...
  async createParkingSession(spaceId: number, category: string): Promise<ParkingSession> {
  ...
  async endParkingSession(sessionId: string): Promise<CheckOutResponseDto | null> {
    // get given session
